            ...
            <section className="relative overflow-hidden pt-0 md:pt-24">
                <div className="mx-auto w-full max-w-container px-4 md:px-8">
                    <div className="mx-auto flex max-w-5xl flex-col gap-7 md:gap-2 items-center text-center">
                        <h1 className="text-display-md text-secondary_on-brand font-semibold text-primary mt-9 md:text-display-lg lg:text-display-xl">
                            Automation for salespeople.{" "}
                        </h1>
                        <p className="mt-4 text-secondary_on-brand max-w-3xl text-lg md:mt-6 md:text-xl">
